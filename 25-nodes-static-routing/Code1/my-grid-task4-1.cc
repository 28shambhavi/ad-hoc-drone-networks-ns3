...
int main (int argc, char *argv[])
{
  ...
  SetStaticRoute(c.Get(20), "10.1.1.1", "10.1.1.16", 1);
  SetStaticRoute(c.Get(15), "10.1.1.1", "10.1.1.11", 1);
  SetStaticRoute(c.Get(10), "10.1.1.1", "10.1.1.6", 1);
  SetStaticRoute(c.Get(5), "10.1.1.1", "10.1.1.1", 1);
  SetStaticRoute(c.Get(24), "10.1.1.1", "10.1.1.19", 1);
  SetStaticRoute(c.Get(18), "10.1.1.1", "10.1.1.13", 1);
  SetStaticRoute(c.Get(12), "10.1.1.1", "10.1.1.7", 1);
  SetStaticRoute(c.Get(6), "10.1.1.1", "10.1.1.1", 1);
  SetStaticRoute(c.Get(4), "10.1.1.1", "10.1.1.4", 1);
  SetStaticRoute(c.Get(3), "10.1.1.1", "10.1.1.3", 1);
  SetStaticRoute(c.Get(2), "10.1.1.1", "10.1.1.2", 1);
  SetStaticRoute(c.Get(1), "10.1.1.1", "10.1.1.1", 1);


  // UDP connection from N20 to N0
  TypeId tid = TypeId::LookupByName ("ns3::UdpSocketFactory");
  Ptr<Socket> recvSink1 = Socket::CreateSocket (c.Get (0), tid);
  InetSocketAddress local1 = InetSocketAddress (Ipv4Address ("10.1.1.1"), 80);//(Ipv4Address::GetAny (), 80);
  recvSink1->Bind (local1);
  recvSink1->SetRecvCallback (MakeCallback (&ReceivePacket));

  Ptr<Socket> source1 = Socket::CreateSocket (c.Get (20), tid);
  InetSocketAddress remote1 = InetSocketAddress (i.GetAddress (0),80);
  source1->Bind ();
  source1->Connect (remote1);

  // UDP connection from N24 to N0
		  // Ptr<Socket> recvSink2 = Socket::CreateSocket (c.Get (0), tid);
  ...
  Ptr<Socket> source2 = Socket::CreateSocket (c.Get (24), tid);
  InetSocketAddress remote2 = InetSocketAddress (i.GetAddress (0),80);
  source2->Bind ();
  ...
  InetSocketAddress remote3 = InetSocketAddress (i.GetAddress (0),80);
  source3->Bind ();
  ...
  wifiPhy.EnablePcap ("static-routing", devices);
