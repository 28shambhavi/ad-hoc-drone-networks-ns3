...
int main (int argc, char *argv[])
{
  ...
  Address sinkAddress1 (InetSocketAddress (i.GetAddress (24), sinkPort));
  ...
  packetSink1->TraceConnectWithoutContext ("Rx", MakeBoundCallback (&TraceSink, 24));
  ...
  Ptr<Socket> ns3TcpSocket2 = Socket::CreateSocket (c.Get (10), TcpSocketFactory::GetTypeId ());
  Ptr<MyApp> app2 = CreateObject<MyApp> ();
  app2->Setup (ns3TcpSocket2, sinkAddress2, packetSize, numPackets, DataRate ("0.002Mbps"));
  ...
  Ptr<Socket> ns3TcpSocket3 = Socket::CreateSocket (c.Get (20), TcpSocketFactory::GetTypeId ());
  Ptr<MyApp> app3 = CreateObject<MyApp> ();
  app3->Setup (ns3TcpSocket3, sinkAddress3, packetSize, numPackets, DataRate ("0.002Mbps"));
