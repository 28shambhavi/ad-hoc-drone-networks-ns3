...
int main (int argc, char *argv[])
{
  ...
  app1->Setup (ns3TcpSocket1, sinkAddress1, packetSize, numPackets, DataRate ("0.001Mbps"));
  ...
  app2->Setup (ns3TcpSocket2, sinkAddress2, packetSize, numPackets, DataRate ("0.001Mbps"));
  ...
  app3->Setup (ns3TcpSocket3, sinkAddress3, packetSize, numPackets, DataRate ("0.001Mbps"));
